...
word_emb_path = '/mnt/g/Pretrained Model/Glove/glove.840B.300d/glove.840B.300d.txt'
...
def get_args():
    ...
    parser.add_argument('--k', type=int, default=7,
                        help='number of cluster centers (default: 7)')
    parser.add_argument('--v1', type=int, default=0.8,
                        help='weight for total_inter (default: 0.8)')
    parser.add_argument('--v2', type=int, default=1.0,
                        help='weight for Fibonacci (default: 1.0)')
    parser.add_argument('--xi', type=int, default=3.0,
                        help='weight for inter_margin (default: 3.0)')
    parser.add_argument('--alpha_', type=int, default=1.0,
                        help='weight for adaptive margin between cluster centers (default: 1.0)')


    # Training Setting
    parser.add_argument('--batch_size', type=int, default=64, metavar='N',  
                        help='batch size (mosi: 64, mosei: 128)')
