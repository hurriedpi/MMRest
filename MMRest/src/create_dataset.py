...
class MOSI:
    def __init__(self, config):
        ...
        try:
            ...
            pickle_filename = '/mnt/h/Demo2/MMRest/MMRest-main/MMRest/datasets/MOSI/mosi_data_noalign.pkl'
            csv_filename = '/mnt/h/Demo2/MMRest/MMRest-main/MMRest/datasets/MOSI/MOSI-label.csv'
...
class MOSEI:
    def __init__(self, config):
        ...
        try:
            ...
            # load pickle file for unaligned acoustic and visual source
            pickle_filename = '/mnt/h/Demo2/MMRest/MMRest-main/MMRest/datasets/MOSEI/mosei_senti_data_noalign.pkl'
            csv_filename = '/mnt/h/Demo2/MMRest/MMRest-main/MMRest/datasets/MOSEI/MOSEI-label.csv'
